...
// These tests cover only 2d_unet/3d_unet
    ...
    ::testing::Combine(
        ::testing::Combine(::testing::Combine(::testing::Values(std::vector<size_t>({3, 3})),       // kernel
                           ...
                           ::testing::ValuesIn(std::vector<InferenceEngine::Precision>{
                               InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP16}),  // Net precisions
                           ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),                // Input precision
                           ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),  // Output precision
                           ::testing::Values(InferenceEngine::Layout::ANY),             // Input layout
                           ::testing::Values(InferenceEngine::Layout::ANY),             // Output layout
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 1, 144, 144, 144), (16, 1, 3, 3, 3), (1, 16, 1, 1, 1) Out:    (1, 16, 144, 144, 144) Operators:
// '3d_unet-graph-transform-cuda:opid3' [FP32]
INSTANTIATE_TEST_CASE_P(
    autogen_FusedConvolution_3d_unet_graph_transform_cuda_opid3,
    ConvolutionBiasAddActivationLayerFiniteComparerTest,
    ::testing::Combine(
        ::testing::Combine(::testing::Combine(::testing::Values(std::vector<size_t>({3, 3, 3})),     // kernel
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 128, 18, 18, 18), (128, 128, 3, 3, 3), (1, 128, 1, 1, 1) Out:    (1, 128, 18, 18, 18) Operators:
// '3d_unet-graph-transform-cuda:opid27' [FP32], '3d_unet-graph-transform-cuda:opid45' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 128, 36, 36, 36), (64, 128, 3, 3, 3), (1, 64, 1, 1, 1) Out:    (1, 64, 36, 36, 36) Operators:
// '3d_unet-graph-transform-cuda:opid53' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 128, 9, 9, 9), (256, 128, 3, 3, 3), (1, 256, 1, 1, 1) Out:    (1, 256, 9, 9, 9) Operators:
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 16, 144, 144, 144), (16, 16, 3, 3, 3), (1, 16, 1, 1, 1) Out:    (1, 16, 144, 144, 144)
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 16, 72, 72, 72), (32, 16, 3, 3, 3), (1, 32, 1, 1, 1) Out:    (1, 32, 72, 72, 72) Operators:
// '3d_unet-graph-transform-cuda:opid10' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 256, 18, 18, 18), (128, 256, 3, 3, 3), (1, 128, 1, 1, 1) Out:    (1, 128, 18, 18, 18) Operators:
// '3d_unet-graph-transform-cuda:opid42' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 256, 9, 9, 9), (256, 256, 3, 3, 3), (1, 256, 1, 1, 1) Out:    (1, 256, 9, 9, 9) Operators:
// '3d_unet-graph-transform-cuda:opid34' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 32, 144, 144, 144), (16, 32, 3, 3, 3), (1, 16, 1, 1, 1) Out:    (1, 16, 144, 144, 144)
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 32, 36, 36, 36), (64, 32, 3, 3, 3), (1, 64, 1, 1, 1) Out:    (1, 64, 36, 36, 36) Operators:
// '3d_unet-graph-transform-cuda:opid17' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 32, 72, 72, 72), (32, 32, 3, 3, 3), (1, 32, 1, 1, 1) Out:    (1, 32, 72, 72, 72) Operators:
// '3d_unet-graph-transform-cuda:opid13' [FP32], '3d_unet-graph-transform-cuda:opid67' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 64, 18, 18, 18), (128, 64, 3, 3, 3), (1, 128, 1, 1, 1) Out:    (1, 128, 18, 18, 18) Operators:
// '3d_unet-graph-transform-cuda:opid24' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 64, 36, 36, 36), (64, 64, 3, 3, 3), (1, 64, 1, 1, 1) Out:    (1, 64, 36, 36, 36) Operators:
// '3d_unet-graph-transform-cuda:opid20' [FP32], '3d_unet-graph-transform-cuda:opid56' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Attrs:  {'auto_pad': 'same_upper', 'dilations': '1,1,1', 'pads_begin': '1,1,1', 'pads_end': '1,1,1', 'strides':
// '1,1,1'} In:     (1, 64, 72, 72, 72), (32, 64, 3, 3, 3), (1, 32, 1, 1, 1) Out:    (1, 32, 72, 72, 72) Operators:
// '3d_unet-graph-transform-cuda:opid64' [FP32]
INSTANTIATE_TEST_CASE_P(
...
INSTANTIATE_TEST_CASE_P(
    ...
    ConvolutionBiasAddActivationLayerFiniteComparerTest,
    ::testing::Combine(
        ::testing::Combine(::testing::Combine(::testing::Values(std::vector<size_t>({1, 1, 1})),     // kernel
                                              ::testing::Values(std::vector<size_t>({1, 1, 1})),     // strides
