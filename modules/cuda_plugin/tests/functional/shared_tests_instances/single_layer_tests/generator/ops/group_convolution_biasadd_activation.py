...
class TestTraits (CommonTestTraits):
    ...
    def cpp_test_filename(self):
        return 'group_convolution_biasadd_activation_autogenerated.cpp'

    @property
    def template_filename(self):
        return 'group_convolution_biasadd_activation.cpp.jinja2'

    @property
    def default_cpp_test_class_name(self):
        return 'GroupConvolutionBiasAddActivationLayerTest'
...
class TestParamsProvider (TestParamsProviderBase):
    ...
    def cpp_activations(self):
        return '{ngraph::helpers::ActivationTypes::None}'
