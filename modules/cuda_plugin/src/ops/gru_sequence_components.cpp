...
GRUSequenceParams::GRUSequenceParams(const ngraph::op::v5::GRUSequence& node)
    ...
    const size_t num_directions = (direction_ == ngraph::op::RecurrentSequenceDirection::BIDIRECTIONAL) ? 2 : 1;
