...
private:
    ...
    static std::vector<int> tensor_shape_from_ngraph(const ngraph::Shape& ngraph_shape);
    static std::vector<int> spatial_shape_from_ngraph(const ngraph::Shape& ngraph_shape);
    static std::vector<int> tensor_strides_from_ngraph(const ngraph::Shape& ngraph_strides);
