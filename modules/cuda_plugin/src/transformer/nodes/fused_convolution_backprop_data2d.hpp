...
class FusedConvBackpropData2D : public ngraph::op::Op {
 public:
  explicit FusedConvBackpropData2D(
  ...
  inline static constexpr type_info_t type_info{"FusedConvBackpropData2D", 0};
