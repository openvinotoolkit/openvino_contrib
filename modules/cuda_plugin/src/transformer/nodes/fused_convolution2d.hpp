...
class FusedConv2D : public ngraph::op::Op {
 public:
  explicit FusedConv2D(const ngraph::Output<Node>& data_batch,
  ...
  inline static constexpr type_info_t type_info{"FusedConv2D", 0};
