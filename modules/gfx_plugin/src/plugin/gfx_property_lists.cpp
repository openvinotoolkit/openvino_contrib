...
std::vector<ov::PropertyName> gfx_plugin_supported_properties() {
  ...
  std::vector<ov::PropertyName> rw{
      ...
      ov::PropertyName{kGfxDiagnosticF32MpsImageProperty,
...
std::vector<ov::PropertyName> gfx_internal_supported_properties() {
  std::vector<ov::PropertyName> props{
      ...
      ov::PropertyName{ov::internal::threads_per_stream.name(),
                       ov::PropertyMutability::RW},
      ov::PropertyName{ov::internal::compiled_model_runtime_properties.name(),
...
std::vector<ov::PropertyName> gfx_compiled_model_supported_properties() {
  ...
  props.push_back(ov::PropertyName{ov::hint::inference_precision.name(),
                                   ov::PropertyMutability::RW});
  ...
  props.push_back(
      ov::PropertyName{kGfxEnableFusionProperty, ov::PropertyMutability::RW});
  props.push_back(ov::PropertyName{kGfxDiagnosticF32MpsImageProperty,
                                   ov::PropertyMutability::RW});
  props.push_back(
      ov::PropertyName{kGfxBackendProperty, ov::PropertyMutability::RO});
  props.push_back(ov::PropertyName{kGfxProfilingReportProperty,
                                   ov::PropertyMutability::RO});
  props.push_back(
      ov::PropertyName{kGfxMemStatsProperty, ov::PropertyMutability::RO});
  return props;
}
