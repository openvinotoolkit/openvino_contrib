...
mlir::ModuleOp build_mlir_space_to_depth_from_model(const std::shared_ptr<const ov::Model>& model,
    ...
    auto in_ty = to_mlir_type(s2d->get_input_element_type(0), ctx, /*fallback_f32=*/true);
    auto out_ty = to_mlir_type(s2d->get_output_element_type(0), ctx, /*fallback_f32=*/true);
