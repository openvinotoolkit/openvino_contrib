...
void MetalScatterElementsUpdateOp::compile(MetalBufferManager* buffer_manager) {
    ...
    auto spec_init = make_kernel_spec_from_custom_kernel_abi(m_node, "scatter_elements_init");
    auto spec_update = make_kernel_spec_from_custom_kernel_abi(m_node, "scatter_elements_update");
