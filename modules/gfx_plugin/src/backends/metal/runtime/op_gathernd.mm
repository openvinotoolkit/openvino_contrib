...
void MetalGatherNDOp::compile(MetalBufferManager* buffer_manager) {
    ...
    auto spec = make_kernel_spec_from_custom_kernel_abi(m_node, "gathernd_kernel");
    m_kernel = compile_msl_kernel(backend, spec, module, "gathernd_kernel", msl_generator, &log);
