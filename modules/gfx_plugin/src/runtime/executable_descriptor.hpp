...
struct RuntimeStageExecutableDescriptor {
    ...
    compiler::KernelArtifactOrigin origin = compiler::KernelArtifactOrigin::Unknown;
    compiler::KernelArtifactPayloadKind payload_kind = compiler::KernelArtifactPayloadKind::None;
...
struct RuntimeExecutableDescriptor {
    ...
    RuntimeExecutableDescriptorVerificationResult verify(
...
public:
    RuntimeExecutableDescriptor build(const compiler::ExecutableBundle& executable) const;
};
