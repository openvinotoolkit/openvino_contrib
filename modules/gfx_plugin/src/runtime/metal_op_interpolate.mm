...
#import "runtime/metal_op_interpolate.hpp"
...
void MetalInterpolateOp::compile(MetalBufferManager* buffer_manager) {
    ...
    m_pipeline = compiler.compile_msl_from_source(source, "interpolate_kernel", log);
    OPENVINO_ASSERT(m_pipeline, "MetalInterpolateOp: failed to compile kernel: ", log);
...
void MetalInterpolateOp::execute(MetalCommandBufferHandle cmd_buf_handle) {
    ...
    OPENVINO_ASSERT(cb, "MetalInterpolateOp: command buffer is null");
