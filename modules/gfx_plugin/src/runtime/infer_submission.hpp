...
struct InferSubmissionTuningCaps {
    ...
    size_t max_slots_hint = 0;
    size_t stages_per_slot_hint = 0;
    ...
    uint32_t extremely_deep_dependency_extension_budget_num = 0;
    uint32_t extremely_deep_dependency_extension_budget_den = 1;
};
