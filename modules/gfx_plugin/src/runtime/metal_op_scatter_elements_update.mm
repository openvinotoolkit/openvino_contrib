...
#import "runtime/metal_op_scatter_elements_update.hpp"
...
void MetalScatterElementsUpdateOp::compile(MetalBufferManager* buffer_manager) {
    ...
    m_pipeline_init = compiler.compile_msl_from_source(source, "scatter_elements_init", log);
    OPENVINO_ASSERT(m_pipeline_init, "MetalScatterElementsUpdateOp: init kernel compile failed: ", log);
    m_pipeline_update = compiler.compile_msl_from_source(source, "scatter_elements_update", log);
    OPENVINO_ASSERT(m_pipeline_update, "MetalScatterElementsUpdateOp: update kernel compile failed: ", log);
...
void MetalScatterElementsUpdateOp::execute(MetalCommandBufferHandle cmd_buf_handle) {
    ...
    OPENVINO_ASSERT(cb, "MetalScatterElementsUpdateOp: command buffer is null");
