...
static inline uint gfx_reduce_output_coord(uint input_axis, uint out_axis0,
                                           uint out_axis1, uint out_axis2,
                                           uint out_axis3, uint o0, uint o1,
                                           uint o2, uint o3) {
...
static inline uint gfx_reduce_logical_bool_at(
    __global const uchar *src, uint out_idx, uint op, uint out_rank,
    uint in_dim0, uint in_dim1, uint in_dim2, uint in_dim3, uint out_dim1,
    uint out_dim2, uint out_dim3, uint reduce_mask, uint out_axis0,
    uint out_axis1, uint out_axis2, uint out_axis3) {
  uint o0 = 0u;
  uint o1 = 0u;
  uint o2 = 0u;
  uint o3 = 0u;
  ...
  const uint base0 = gfx_reduce_output_coord(
      0u, out_axis0, out_axis1, out_axis2, out_axis3, o0, o1, o2, o3);
  const uint base1 = gfx_reduce_output_coord(
      1u, out_axis0, out_axis1, out_axis2, out_axis3, o0, o1, o2, o3);
  const uint base2 = gfx_reduce_output_coord(
      2u, out_axis0, out_axis1, out_axis2, out_axis3, o0, o1, o2, o3);
  const uint base3 = gfx_reduce_output_coord(
      3u, out_axis0, out_axis1, out_axis2, out_axis3, o0, o1, o2, o3);
      ...
      for (uint r2 = 0u; r2 < r2_count; ++r2) {
        ...
        for (uint r3 = 0u; r3 < r3_count; ++r3) {
          ...
          const uint input_offset =
              ((c0 * in_dim1 + c1) * in_dim2 + c2) * in_dim3 + c3;
...
__kernel void gfx_opencl_generated_reduction_bool(
    __global const uchar *src, __global uchar *dst, uint count, uint op,
    uint rank, uint out_rank, uint in_dim0, uint in_dim1, uint in_dim2,
