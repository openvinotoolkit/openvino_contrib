...
#include "kernel_ir/opencl_kernels/generated/softmax_f16_dynamic_kernel_source.hpp"
...
opencl_generated_softmax_f16_dynamic_kernel_source() noexcept {
  static constexpr GfxKernelSource kKernel{
      "opencl/generated/softmax_f16_dynamic_static_rank", "opencl",
      "gfx_opencl_generated_softmax_dynamic_f16",
      GfxKernelSourceLanguage::OpenCL,
      detail::kOpenClGeneratedSoftmaxDynamicF16KernelSource};
  return kKernel;
}
