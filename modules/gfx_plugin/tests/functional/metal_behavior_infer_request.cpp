...
using MetalInferRequestPropertiesTest = ov::test::utils::GfxSkippedTests<InferRequestPropertiesTest>;
using MetalOVInferRequestBatchedTests = ov::test::utils::GfxSkippedTests<OVInferRequestBatchedTests>;
using MetalOVInferRequestCallbackTests = ov::test::utils::GfxSkippedTests<OVInferRequestCallbackTests>;
using MetalOVInferRequestCancellationTests = ov::test::utils::GfxSkippedTests<OVInferRequestCancellationTests>;
using MetalOVInferRequestIOTensorTest = ov::test::utils::GfxSkippedTests<OVInferRequestIOTensorTest>;
using MetalOVInferRequestInferenceTests = ov::test::utils::GfxSkippedTests<OVInferRequestInferenceTests>;
using MetalOVInferenceChaining = ov::test::utils::GfxSkippedTests<OVInferenceChaining>;
using MetalOVInferenceChainingStatic = ov::test::utils::GfxSkippedTests<OVInferenceChainingStatic>;
using MetalOVInferRequestDynamicTests = ov::test::utils::GfxSkippedTests<OVInferRequestDynamicTests>;
using MetalOVInferRequestWaitTests = ov::test::utils::GfxSkippedTests<OVInferRequestWaitTests>;
using MetalOVInferRequestVariableStateTest = ov::test::utils::GfxSkippedTests<OVInferRequestVariableStateTest>;
using MetalOVInferRequestMultithreadingTests = ov::test::utils::GfxSkippedTests<OVInferRequestMultithreadingTests>;
