  ...
  return ov::test::gfx::runtime_scenario(
      ...
      [activation_builder = std::move(activation_builder)] {
        auto input = std::make_shared<ov::op::v0::Parameter>(
            ov::element::f32, ov::Shape{1, 4, 8, 8});
      ...
      [] { return std::vector<ov::Tensor>{filled_f32({1, 4, 8, 8})}; }, 90,
      atol, rtol);
}
...
RuntimeScenarioPtr dynamic_swish_scenario() {
  return ov::test::gfx::runtime_scenario(
      ...
      [] {
        auto input = std::make_shared<ov::op::v0::Parameter>(
            ov::element::f32, ov::Shape{1, 4, 8, 8});
        auto beta = std::make_shared<ov::op::v0::Parameter>(ov::element::f32,
                                                            ov::Shape{});
...
std::vector<RuntimeScenarioPtr> activation_runtime_scenarios() {
  return {
      activation_scenario("Relu",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v0::Relu>(input);
                          }),
      activation_scenario("Sigmoid",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v0::Sigmoid>(input);
                          }),
      activation_scenario("Tanh",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v0::Tanh>(input);
                          }),
      activation_scenario("Elu",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v0::Elu>(input,
                                                                     0.5);
                          }),
      activation_scenario("Clamp",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v0::Clamp>(
                                input, -0.25, 0.75);
                          }),
      activation_scenario("GeluTanh",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v7::Gelu>(
                                input, ov::op::GeluApproximationMode::TANH);
                          }),
      activation_scenario("GeluErf",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v7::Gelu>(
                                input, ov::op::GeluApproximationMode::ERF);
                          }),
      activation_scenario("HSwish",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v4::HSwish>(input);
                          }),
      activation_scenario("HSigmoid",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v5::HSigmoid>(
                                input);
                          }),
      activation_scenario("SoftPlus",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v4::SoftPlus>(
                                input);
                          }),
      activation_scenario("SwishDefaultBeta",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v4::Swish>(input);
                          }),
      activation_scenario("SwishStaticBeta",
                          [](const ov::Output<ov::Node> &input) {
      ...
      activation_scenario("Erf",
                          [](const ov::Output<ov::Node> &input) {
                            return std::make_shared<ov::op::v0::Erf>(input);
                          }),
  };
}

class ActivationRuntimeTest
...
TEST_P(ActivationRuntimeTest, MatchesTemplate) {
  ...
  runner.compare_model(scenario.make_model(), scenario.make_inputs(),
                       scenario.timeout_seconds(), scenario.atol(),
                       scenario.rtol());
}

INSTANTIATE_TEST_SUITE_P(Activation, ActivationRuntimeTest,
