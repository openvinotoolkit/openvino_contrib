...
std::vector<uint32_t> reduce_axes12_keep_dims_static_u32_scalars() {
  return {3, 3, 2, 3, 4, 1, 2, 1, 1, 1, 6, 0, 4, 4, 4};
}

std::vector<GfxOpenClSourceScalarArg> reduction_opencl_scalar_args() {
...
struct ReductionOpenClArtifactCase {
  std::string name;
  std::function<std::shared_ptr<ov::Node>()> make_node;
  std::string expected_source_id = "opencl/generated/reduction_f32";
  std::string expected_entry_point = "gfx_opencl_generated_reduction_f32";
...
std::vector<ReductionOpenClArtifactCase> reduction_opencl_artifact_cases() {
  return {
      {"ReduceSumF32",
       ...
       "opencl/generated/reduction_f32", "gfx_opencl_generated_reduction_f32",
      ...
      {"ReduceLogicalAndBool",
       ...
       "opencl/generated/reduction_bool", "gfx_opencl_generated_reduction_bool",
       GfxOpenClArtifactOp::ReduceLogicalAnd,
      ...
      {"ReduceLogicalOrBoolKeepDims",
       ...
       "opencl/generated/reduction_bool", "gfx_opencl_generated_reduction_bool",
       GfxOpenClArtifactOp::ReduceLogicalOr,
       reduce_axes12_keep_dims_static_u32_scalars()},
  };
}

class ReductionOpenClArtifactContract final {
public:
  explicit ReductionOpenClArtifactContract(
  ...
  void verify() const {
    ...
    const auto unit =
        compiler::resolve_opencl_reduction_kernel_unit(node, registry);
    ...
    OpenClSourceArtifactVerifier(node)
        .expect_artifact(GfxKernelStageFamily::Reduction,
                         ...
                         19u, 1u, reduction_opencl_scalar_args(), {0},
                         m_case.static_u32_scalars)
        .has_op(m_case.op)
...
class ReductionOpenClArtifactContractTest
    : public ::testing::TestWithParam<ReductionOpenClArtifactCase> {};

TEST_P(ReductionOpenClArtifactContractTest,
       UsesGeneratedOpenClKernelArtifactContract) {
  ReductionOpenClArtifactContract(GetParam()).verify();
}

INSTANTIATE_TEST_SUITE_P(Reduction, ReductionOpenClArtifactContractTest,
