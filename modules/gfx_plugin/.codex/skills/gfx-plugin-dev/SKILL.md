...
- For hybrid Metal paths, also keep `gfx_kernel_manifest.hpp`, `gfx_mpsrt_kernel_manifest_adapter.hpp`, and `gfx_mpsrt_source_plan.hpp` aligned with that contract.
