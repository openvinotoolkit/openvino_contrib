...
BitwiseLeftShift::BitwiseLeftShift(Type_t element_type, size_t out_num_elements, size_t max_threads_per_block)
    : impl_{element_type, out_num_elements, max_threads_per_block} {}

void BitwiseLeftShift::operator()(cudaStream_t stream,
                                   const void* in0,
