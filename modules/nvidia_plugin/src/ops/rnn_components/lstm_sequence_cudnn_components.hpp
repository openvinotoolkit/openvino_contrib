 ...
 */
class LSTMSequenceParamsCuDnn {
public:
    LSTMSequenceParamsCuDnn(const LSTMSequenceParams& params);
 ...
 */
class LSTMSequenceDescriptorsCuDnn {
public:
    ...
    LSTMSequenceDescriptorsCuDnn(const CreationContext& context,
...
private:
    const LSTMSequenceParamsCuDnn& params_;
