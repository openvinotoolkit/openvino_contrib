...
ConvertOp::ConvertOp(const CreationContext& context,
    ...
    OPENVINO_ASSERT(input_element_type >= Type_t::boolean && input_element_type <= Type_t::u64);
    OPENVINO_ASSERT(output_element_type >= Type_t::boolean && output_element_type <= Type_t::u64);
    ...
    OPENVINO_ASSERT(size == output_size);
