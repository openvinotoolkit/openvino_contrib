...
RegexNormalization::RegexNormalization(
        const ov::OutputVector& arguments, const std::shared_ptr<re2::RE2> search_pattern_re, const absl::string_view replace_pattern
...
bool RegexNormalization::evaluate(ov::TensorVector& outputs, const ov::TensorVector& inputs) const {
    return evaluate_normalization_helper(
        ...
        [this](const std::string& str) {
            ...
            re2::RE2::GlobalReplace(&result, *this->m_search_pattern_re, this->m_replace_pattern);
            return result;
    });
}
