...
INSTANTIATE_TEST_CASE_P(smoke_DepthToSpaceBS2Test, DepthToSpaceLayerTest, DepthToSpaceBS2, DepthToSpaceLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_CASE_P(smoke_DepthToSpaceBS3Test, DepthToSpaceLayerTest, DepthToSpaceBS3, DepthToSpaceLayerTest::getTestCaseName);
