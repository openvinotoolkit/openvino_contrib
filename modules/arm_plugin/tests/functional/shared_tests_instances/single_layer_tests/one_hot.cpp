...
const std::vector<int64_t> argAxis_Ax = {0, 1, 3, -5};
const std::vector<std::vector<size_t>> inputShapes_Ax = {{4, 8, 5, 9}};
...
const std::vector<ngraph::element::Type> argDepthType_T = { ngraph::element::u8 };
const std::vector<int64_t> argDepth_T = { 1 };
const std::vector<ngraph::element::Type> argSetType_T = { ngraph::element::u8, ngraph::element::f32 };
