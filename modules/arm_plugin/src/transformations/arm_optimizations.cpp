...
bool ArmPlugin::pass::ArmOptimizations::run_on_model(const std::shared_ptr<ov::Model> &m) {
    auto quantized = _lpt && ngraph::pass::low_precision::LowPrecision::isFunctionQuantized(m);
    {
        ...
        if (quantized) {
            manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::DisableConvertConstantFoldingOnConstPath>(
        ...
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::RemoveFilteringBoxesBySize>();
        manager.register_pass<ngraph::pass::ConstantFolding>();
        // may introduce fake dynamism
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::NopElimination>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ReplacePowerByMul>();
        manager.register_pass<ngraph::pass::ConstantFolding>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::SoftPlusFusion>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::HSwishFusion>();

        // LinOpSequenceFusion must be executed after all decompositions
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::LinOpSequenceFusion>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::RNNCellDecomposition>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::LSTMCellDecomposition>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::GRUCellDecomposition>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertGELU>();
        manager.register_pass<ngraph::pass::ConstantFolding>();
        ...
        manager.register_pass<ngraph::pass::ConstantFolding>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvolutionMultiplyFusion>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::GroupConvolutionMultiplyFusion>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvolutionBackpropDataMultiplyFusion>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::GroupConvolutionBackpropDataMultiplyFusion>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertTensorIteratorToGRUSequence>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertTensorIteratorToLSTMSequence>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertTensorIteratorToRNNSequence>();
        manager.register_pass<ngraph::pass::ConstantFolding>();


        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertInterpolate1ToInterpolate4>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertMVN1ToMVN6>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertQuantizeDequantize>();
        // #ifndef __ARM_FEATURE_FP16_VECTOR_ARITHMETIC
            manager.register_pass<pass::ConvertPrecision>(ngraph::element::f16, ngraph::element::f32);
        // #endif
        ...
        if (quantized) {
            pass_config->set_callback<pass::ConvertQuantizeDequantize>([](ConstNodePtr& node) -> bool {
                return ngraph::pass::low_precision::NetworkHelper::areQuantizeAndDequantizeSupportedForMultiply(node);
            });

            pass_config->set_callback<pass::ConvertSubtract>([](ConstNodePtr& node) -> bool {
...

    {
        ...
        ov::pass::Manager manager;
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::LogSoftmaxDecomposition>();
        ...
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ReduceL1Decomposition>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ReduceL2Decomposition>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertReduceMeanToPooling>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertReduceMaxToPooling>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertReduceSumToPooling>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertMod>();
        manager.register_pass<ngraph::pass::ConstantFolding>();
        ...
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertNMS5ToNMS9>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertReorgYolo>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertMaxPool8ToMaxPool1>();
        ...
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertGather8ToGather7>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertSoftMax8ToSoftMax1>();
        ...
        manager.register_pass<ngraph::pass::ConstantFolding>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertDivide>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertBroadcast3>();
        manager.register_pass<ov::pass::GraphRewrite>()->add_matcher<pass::ConvertBroadcastToTiles>();
