...
NGRAPH_RTTI_DEFINITION(ArmPlugin::pass::ConvertBatchNormInferenceToARM, "ConvertBatchNormInferenceToARM", 0);
ArmPlugin::pass::ConvertBatchNormInferenceToARM::ConvertBatchNormInferenceToARM() {
    auto bnv5 = ov::pass::pattern::wrap_type<ov::op::v5::BatchNormInference>();
    ov::matcher_pass_callback callback = [=](ov::pass::pattern::Matcher& m) {
        ...
        bnv_arm->set_friendly_name(bnv5->get_friendly_name() + "/arm");
        ov::copy_runtime_info(bnv5, bnv_arm);
        ov::replace_node(bnv5, bnv_arm);
        return true;
    };
    auto m = std::make_shared<ov::pass::pattern::Matcher>(bnv5, "ConvertBatchNormInferenceToARM");
