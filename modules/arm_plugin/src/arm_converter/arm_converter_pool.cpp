...
template<> Converter::Conversion::Ptr Converter::Convert(const opset::v1::ArmMaxPool& node) {
...
template<> Converter::Conversion::Ptr Converter::Convert(const opset::v8::ArmMaxPool& node) {
    if ((node.get_input_shape(0).size() == 4) &&
...
template<> Converter::Conversion::Ptr Converter::Convert(const opset::v1::ArmAvgPool& node) {
