...
This specification document based on [opset5](https://github.com/openvinotoolkit/openvino/blob/master/docs/ops/opset5.md) operation set supported in OpenVINO.
Examples of operation instances are expressed as IR V10 xml snippets. Such IR is generated by the Model Optimizer.
The semantics match corresponding nGraph operation classes declared in `namespace opset5`. ARM plugin doesn't support operations with dynamic shape.
...
| [MVN](https://github.com/openvinotoolkit/openvino/blob/master/docs/ops/normalization/MVN_1.md)                                                 | Supported*    |
...
| [Reverse](https://github.com/openvinotoolkit/openvino/blob/master/docs/ops/movement/Reverse_1.md)                                              | Not Supported |
