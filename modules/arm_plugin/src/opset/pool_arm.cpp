...
opset::v1::ArmMaxPool::ArmMaxPool(const ov::Output<Node>& arg,
                                  ...
                                  const ov::op::PadType& auto_pad) : m_output_shape{output_shape} {
    set_arguments({arg});
    set_strides(strides);
...
std::shared_ptr<ov::Node> opset::v1::ArmMaxPool::clone_with_new_inputs(const ov::OutputVector& new_args) const {
    return std::make_shared<ArmMaxPool>(new_args.at(0), m_strides, m_pads_begin, m_pads_end, m_kernel, m_output_shape, m_rounding_type, m_auto_pad);
}
...
opset::v8::ArmMaxPool::ArmMaxPool(const ov::Output<Node>& arg,
                                  ...
                                  int64_t axis) : m_output_shape{output_shape} {
    set_arguments({arg});
    set_strides(strides);
...
std::shared_ptr<ov::Node> opset::v8::ArmMaxPool::clone_with_new_inputs(const ov::OutputVector& new_args) const {
    return std::make_shared<ArmMaxPool>(new_args.at(0), m_strides, get_dilations(), m_pads_begin, m_pads_end, m_kernel, m_output_shape, m_rounding_type, m_auto_pad, get_index_element_type(), get_axis());
}
...
std::shared_ptr<ov::Node> opset::v1::ArmAvgPool::clone_with_new_inputs(const ov::OutputVector& new_args) const {
    return std::make_shared<ArmAvgPool>(new_args.at(0), m_strides, m_pads_begin, m_pads_end, m_kernel, m_exclude_pad, m_output_shape, m_rounding_type, m_auto_pad);
}
