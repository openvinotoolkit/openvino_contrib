...
| [Gather](https://github.com/openvinotoolkit/openvino/blob/master/docs/ops/movement/Gather_7.md)                                                                                          | Supported*    |
| [Gather_8](https://github.com/openvinotoolkit/openvino/blob/master/docs/ops/movement/Gather_8.md)                                                                                        | Supported*   |
...
* `'Gather_8'` convert to `'Gather'` and layer is supported as  via arm_compute library with non negative indices else use reference relaization. 
