...
class METAL_OP_API MetalScatterElementsUpdateOp : public MetalOp {
public:
...
private:
    ...
    id<MTLComputePipelineState> m_pipeline_init = nil;
    id<MTLComputePipelineState> m_pipeline_update = nil;
};
