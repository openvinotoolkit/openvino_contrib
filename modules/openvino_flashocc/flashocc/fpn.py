...
# Adapted from mmdetection FPN (https://github.com/open-mmlab/mmdetection), Apache-2.0, Copyright (c) OpenMMLab.

import torch.nn as nn
import torch.nn.functional as F

from .layers import BaseModule, ConvModule, auto_fp16
