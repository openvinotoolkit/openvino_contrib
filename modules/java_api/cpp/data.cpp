...
JNIEXPORT void JNICALL Java_org_intel_openvino_Data_setLayout(JNIEnv *env, jobject obj, jlong addr, jint layout)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_Data_getLayout(JNIEnv *env, jobject, jlong addr)
{
...
JNIEXPORT jintArray JNICALL Java_org_intel_openvino_Data_GetDims(JNIEnv *env, jobject obj, jlong addr)
{
