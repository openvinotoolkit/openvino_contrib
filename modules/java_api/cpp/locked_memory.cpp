...
JNIEXPORT void JNICALL Java_org_intel_openvino_LockedMemory_asLong(JNIEnv *env, jobject obj, jlong addr, jlongArray res)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_LockedMemory_asInt(JNIEnv *env, jobject obj, jlong addr, jintArray res)
{
