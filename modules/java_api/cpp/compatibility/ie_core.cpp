...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_GetCore(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_GetCore1(JNIEnv *env, jobject obj, jstring xmlConfigFile)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_ReadNetwork1(JNIEnv *env, jobject obj, jlong coreAddr, jstring xml, jstring bin)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_ReadNetwork(JNIEnv *env, jobject obj, jlong coreAddr, jstring xml)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_LoadNetwork(JNIEnv *env, jobject obj, jlong coreAddr, jlong netAddr, jstring device)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_LoadNetwork1(JNIEnv *env, jobject obj, jlong coreAddr, jlong netAddr, jstring device, jobject config)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_IECore_SetConfig(JNIEnv *env, jobject obj, jlong addr, jobject config, jstring deviceName)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_IECore_SetConfig1(JNIEnv *env, jobject obj, jlong addr, jobject config)
{
    static const char method_name[] = "SetConfig";
    try
    {   
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_IECore_GetConfig(JNIEnv *env, jobject obj, jlong addr, jstring deviceName, jstring name)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_IECore_delete(JNIEnv *, jobject, jlong addr)
{
    Core *core = (Core *)addr;
    delete core;
}
