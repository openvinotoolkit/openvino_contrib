...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_getBatchSize(JNIEnv *env, jobject, jlong addr)
{
...
JNIEXPORT jobject JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_GetInputsInfo(JNIEnv *env, jobject obj, jlong addr)
{
    ...
    try
    {
        ...
        jclass inputInfoClass = env->FindClass("org/intel/openvino/compatibility/InputInfo");
...
JNIEXPORT jobject JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_GetOutputsInfo(JNIEnv *env, jobject obj, jlong addr)
{
    ...
    try
    {
        ...
        jclass outputInfoClass = env->FindClass("org/intel/openvino/compatibility/Data");
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_reshape(JNIEnv *env, jobject obj, jlong addr, jobject input)
{
...
JNIEXPORT jobject JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_getInputShapes(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_addOutput(JNIEnv *env, jobject obj, jlong addr, jstring layerName, jint outputIndex){
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_addOutput1(JNIEnv *env, jobject obj, jlong addr, jstring layerName){
    static const char method_name[] = "addOutput";
    try
    {
        CNNNetwork *network = (CNNNetwork *)addr;
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_CNNNetwork_delete(JNIEnv *env, jobject obj, jlong addr)
{
    CNNNetwork *network = (CNNNetwork *)addr;
    delete network;
}
