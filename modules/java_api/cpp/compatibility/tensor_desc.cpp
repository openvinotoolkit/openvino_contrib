...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_TensorDesc_GetTensorDesc(JNIEnv *env, jobject obj, jint precision, jintArray dims, jint layout)
{
...
JNIEXPORT jintArray JNICALL Java_org_intel_openvino_compatibility_TensorDesc_GetDims(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_TensorDesc_getLayout(JNIEnv *env, jobject, jlong addr)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_TensorDesc_getPrecision(JNIEnv *env, jobject, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_TensorDesc_delete(JNIEnv *, jobject, jlong addr)
{
    TensorDesc *tDesk = (TensorDesc *)addr;
    delete tDesk;
}
