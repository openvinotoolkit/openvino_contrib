...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_InputInfo_getPreProcess(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InputInfo_SetLayout(JNIEnv *env, jobject obj, jlong addr, jint layout)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_InputInfo_getLayout(JNIEnv *env, jobject, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InputInfo_SetPrecision(JNIEnv *env, jobject obj, jlong addr, jint precision)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_InputInfo_getPrecision(JNIEnv *env, jobject, jlong addr)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_InputInfo_GetTensorDesc(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InputInfo_delete(JNIEnv *env, jobject obj, jlong addr) {}
