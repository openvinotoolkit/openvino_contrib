...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_GetTensorDesc(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_GetBlob(JNIEnv *env, jobject obj, jlong tensorDescAddr)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_BlobByte(JNIEnv *env, jobject obj, jlong tensorDescAddr, jbyteArray data)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_BlobFloat(JNIEnv *env, jobject obj, jlong tensorDescAddr, jfloatArray data)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_BlobInt(JNIEnv *env, jobject obj, jlong tensorDescAddr, jintArray data)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_BlobLong(JNIEnv *env, jobject obj, jlong tensorDescAddr, jlongArray data)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_BlobCArray(JNIEnv *env, jobject obj, jlong tensorDescAddr, jlong matDataAddr)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_Blob_size(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT jlong JNICALL Java_org_intel_openvino_compatibility_Blob_rmap(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_Blob_delete(JNIEnv *, jobject, jlong addr)
{
    Blob::Ptr *output = reinterpret_cast<Blob::Ptr *>(addr);
    delete output;
}
