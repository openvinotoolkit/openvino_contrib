...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InferRequest_Infer(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InferRequest_StartAsync(JNIEnv *env, jobject obj, jlong addr)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_InferRequest_Wait(JNIEnv *env, jobject obj, jlong addr, jint wait_mode)
{
...
JNIEXPORT jint JNICALL Java_org_intel_openvino_compatibility_InferRequest_SetCompletionCallback(JNIEnv *env, jobject, jlong addr, jobject runnable){
...
JNIEXPORT long JNICALL Java_org_intel_openvino_compatibility_InferRequest_GetBlob(JNIEnv *env, jobject obj, jlong addr, jstring output_name)
{
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InferRequest_SetBlob(JNIEnv *env, jobject obj, jlong addr, jstring input_name, jlong blobAddr)
{
...
JNIEXPORT jobject JNICALL Java_org_intel_openvino_compatibility_InferRequest_GetPerformanceCounts(JNIEnv *env, jobject, jlong addr)
{
    ...
    try
    {
        ...
        jclass IEProfileInfo_class = env->FindClass("org/intel/openvino/compatibility/InferenceEngineProfileInfo");
        jmethodID IEProfileInfo_init_id = env->GetMethodID(IEProfileInfo_class,"<init>",
                                                           "(Lorg/intel/openvino/compatibility/InferenceEngineProfileInfo$LayerStatus;JJLjava/lang/String;Ljava/lang/String;I)V");

        jclass layerStatus_enum = env->FindClass("org/intel/openvino/compatibility/InferenceEngineProfileInfo$LayerStatus");
        jmethodID valueOf_method_id = env->GetStaticMethodID(layerStatus_enum,"valueOf","(I)Lorg/intel/openvino/compatibility/InferenceEngineProfileInfo$LayerStatus;");
...
JNIEXPORT void JNICALL Java_org_intel_openvino_compatibility_InferRequest_delete(JNIEnv *env, jobject, jlong addr)
{
